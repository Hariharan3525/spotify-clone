    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            <div className='flex gap-4'>
                ...
                {playStatus ? <img onClick={pause} className='w-4 cursor-pointer' src={assets.pause_icon} alt="pause_icon" /> :
                            <img onClick={play} className='w-4 cursor-pointer' src={assets.play_icon} alt="play_icon" />
                }
                <img onClick={previous} className='w-4 cursor-pointer' src={assets.next_icon} alt="next_icon" />
                <img onClick={next} className='w-4 cursor-pointer' src={assets.loop_icon} alt="loop_icon" />
            </div>
        ...
        <div className='hidden lg:flex items-center gap-2 opacity-75'>
            ...
            <img className='w-4' src={assets.mini_player_icon} alt="miniplayer_icon" />
